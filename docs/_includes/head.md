<head>
  ...
  <link href="{{ site.url | append: site.baseurl }}/assets/default.css" rel="stylesheet" type="text/css">
  ...
  <link id="favicon" rel="shortcut icon" href="https://a.slack-edge.com/4f28/img/icons/favicon-32.png"
