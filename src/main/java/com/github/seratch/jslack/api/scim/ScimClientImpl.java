...
public class ScimClientImpl implements ScimClient {
  ...
  public UsersDeleteResponse delete(UsersDeleteRequest req) throws IOException, SlackApiException {
    ...
    return doPostForm(request, UsersDeleteResponse.class);
  }

  private <T> T doPostForm(Request.Builder requestBuilder, Class<T> clazz) throws IOException, SlackApiException {
