...
@Slf4j
public class DialogSubmissionTest {
    ...
    String realPayload = "{\"type\":\"dialog_submission\",\"token\":\"legacy-fixed-value\",\"action_ts\":\"1583637736.891623\",\"team\":{\"id\":\"T123\",\"domain\":\"test-test\"},\"user\":{\"id\":\"U123\",\"name\":\"test-test\"},\"channel\":{\"id\":\"C123\",\"name\":\"dev\"},\"submission\":{\"loc_origin\":\"test\",\"loc_destination\":\"aaa\"},\"callback_id\":\"dialog-test\",\"response_url\":\"https:\\/\\/hooks.slack.com\\/app\\/T123\\/123\\/46l0Ngwg4jmNLXyWYVTk51BK\",\"state\":\"Limo\"}";

    @Test
    public void test() throws Exception {
        App app = buildApp();
        app.dialogSubmission("dialog-test", (req, ctx) -> ctx.ack());
        ...
        DialogSubmissionRequest req = new DialogSubmissionRequest(requestBody, realPayload, new RequestHeaders(rawHeaders));
    ...
    public void skipped() throws Exception {
        App app = buildApp();
        app.dialogSubmission("dialog-test-2", (req, ctx) -> ctx.ack());
