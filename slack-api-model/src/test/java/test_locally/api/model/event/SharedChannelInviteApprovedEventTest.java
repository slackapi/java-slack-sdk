...
public class SharedChannelInviteApprovedEventTest {

    @Test
    public void typeName() {
        assertThat(SharedChannelInviteApprovedEvent.TYPE_NAME, is("shared_channel_invite_approved"));
    }
    ...
    public void deserialize() {
        String json = "{\n" +
                ...
                "}";
        SharedChannelInviteApprovedEvent event = GsonFactory.createSnakeCase().fromJson(json, SharedChannelInviteApprovedEvent.class);
        assertThat(event.getType(), is("shared_channel_invite_approved"));
    }

    @Test
    public void serialize() {
        Gson gson = GsonFactory.createSnakeCase();
        SharedChannelInviteApprovedEvent event = new SharedChannelInviteApprovedEvent();
        String generatedJson = gson.toJson(event);
        String expectedJson = "{\"type\":\"shared_channel_invite_approved\"}";
