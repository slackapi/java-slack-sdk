...
public class UserProfileChangedEventTest {

    @Test
    public void typeName() {
        assertThat(UserProfileChangedEvent.TYPE_NAME, is("user_profile_changed"));
    }
    ...
    public void deserialize() {
        String json = "{\n" +
                ...
                "  \"event_ts\": \"1652050558.234800\"\n" +
                "}";
        UserProfileChangedEvent event = GsonFactory.createSnakeCase().fromJson(json, UserProfileChangedEvent.class);
        assertThat(event.getType(), is("user_profile_changed"));
    ...
    public void serialize() {
        ...
        String expectedJson = "{\"type\":\"user_profile_changed\"}";
