...
public class FileUnsharedPayloadTest {
    ...
    public void test() throws IOException {
        String json = fileReader.readWholeAsString("/" + FileUnsharedPayload.class.getSimpleName() + ".json");
        FileUnsharedPayload payload = gson.fromJson(json, FileUnsharedPayload.class);
