...
public class FileSharedPayloadTest {
    ...
    public void test() throws IOException {
        String json = fileReader.readWholeAsString("/" + FileSharedPayload.class.getSimpleName() + ".json");
        FileSharedPayload payload = gson.fromJson(json, FileSharedPayload.class);
