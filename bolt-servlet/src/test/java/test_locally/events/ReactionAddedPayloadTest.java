...
public class ReactionAddedPayloadTest {
    ...
    public void test() throws IOException {
        String json = fileReader.readWholeAsString("/" + ReactionAddedPayload.class.getSimpleName() + ".json");
        ReactionAddedPayload payload = gson.fromJson(json, ReactionAddedPayload.class);
