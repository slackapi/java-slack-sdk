...
public class LinkSharedPayloadTest {
    ...
    public void test() throws IOException {
        String json = fileReader.readWholeAsString("/" + LinkSharedPayload.class.getSimpleName() + ".json");
        LinkSharedPayload payload = gson.fromJson(json, LinkSharedPayload.class);
