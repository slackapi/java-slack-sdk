...
public class SubteamSelfAddedPayloadTest {
    ...
    public void test() throws IOException {
        String json = fileReader.readWholeAsString("/" + SubteamSelfAddedPayload.class.getSimpleName() + ".json");
        SubteamSelfAddedPayload payload = gson.fromJson(json, SubteamSelfAddedPayload.class);
