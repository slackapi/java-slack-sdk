...
public class ReactionRemovedPayloadTest {
    ...
    public void test() throws IOException {
        String json = fileReader.readWholeAsString("/" + ReactionRemovedPayload.class.getSimpleName() + ".json");
        ReactionRemovedPayload payload = gson.fromJson(json, ReactionRemovedPayload.class);
