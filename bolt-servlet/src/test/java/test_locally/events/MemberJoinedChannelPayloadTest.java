...
public class MemberJoinedChannelPayloadTest {
    ...
    public void test() throws IOException {
        String json = fileReader.readWholeAsString("/" + MemberJoinedChannelPayload.class.getSimpleName() + ".json");
        MemberJoinedChannelPayload payload = gson.fromJson(json, MemberJoinedChannelPayload.class);
