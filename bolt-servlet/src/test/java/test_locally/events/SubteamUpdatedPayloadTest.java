...
public class SubteamUpdatedPayloadTest {
    ...
    public void test() throws IOException {
        String json = fileReader.readWholeAsString("/" + SubteamUpdatedPayload.class.getSimpleName() + ".json");
        SubteamUpdatedPayload payload = gson.fromJson(json, SubteamUpdatedPayload.class);
