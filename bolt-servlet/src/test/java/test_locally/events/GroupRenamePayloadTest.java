...
public class GroupRenamePayloadTest {
    ...
    public void test() throws IOException {
        String json = fileReader.readWholeAsString("/" + GroupRenamePayload.class.getSimpleName() + ".json");
        GroupRenamePayload payload = gson.fromJson(json, GroupRenamePayload.class);
