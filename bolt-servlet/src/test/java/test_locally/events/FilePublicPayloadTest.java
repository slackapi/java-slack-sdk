...
public class FilePublicPayloadTest {
    ...
    public void test() throws IOException {
        String json = fileReader.readWholeAsString("/" + FilePublicPayload.class.getSimpleName() + ".json");
        FilePublicPayload payload = gson.fromJson(json, FilePublicPayload.class);
