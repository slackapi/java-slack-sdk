...
public class DndUpdatedPayloadTest {
    ...
    public void test() throws IOException {
        String json = fileReader.readWholeAsString("/" + DndUpdatedPayload.class.getSimpleName() + ".json");
        DndUpdatedPayload payload = gson.fromJson(json, DndUpdatedPayload.class);
